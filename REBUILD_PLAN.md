...
| M7 | Player rebuild (Media3, library/EQ/comfort/advanced) | queue/EQ/gapless/lyrics instrumented-green on emulator; DSP chain order law verified by unit test; physical BT/USB-DAC route-change test executed (emulator green insufficient) | ☐ |
