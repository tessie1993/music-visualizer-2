...
class CustomShaderLastGoodSourceTest {
    private val renderer: String by lazy { repoFile("src/main/java/dev/geode/render/VisualizerRenderer.kt") }
    private val shaderScene: String by lazy { repoFile("src/main/java/dev/geode/render/scene/ShaderScene.kt") }
