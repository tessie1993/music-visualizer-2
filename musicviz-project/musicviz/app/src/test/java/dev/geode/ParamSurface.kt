...
object ParamSurface {
    ...
    private const val SOURCES = "app/src/main/java/dev/geode/"
    ...
    /** Every [dev.geode.render.scene.SceneParams] field, in declaration order. */
    ...
    /** A main source file, by its path under `dev/geode/`. */
