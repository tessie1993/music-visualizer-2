...
import dev.geode.engine.audio.FrameLevels
import dev.geode.engine.audio.SpectralDescriptors
import dev.geode.engine.audio.SpectralFlux
    ...
    private class Measured(
        ...
        init {
            ...
            for (k in 0 until frames) {
                ...
                WindowTable(nFft, dev.geode.engine.audio.WindowShape.RECTANGULAR).applyInto(mono, start, raw)
