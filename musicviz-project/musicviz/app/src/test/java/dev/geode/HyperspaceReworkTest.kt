...
import dev.geode.render.scene.SpectralSummary
...
class HyperspaceReworkTest {
    ...
    private val sceneSource: String by lazy { repoFile("app/src/main/java/dev/geode/render/scene/HyperspaceScene.kt") }
