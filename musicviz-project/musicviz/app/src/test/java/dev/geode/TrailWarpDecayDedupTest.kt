...
class TrailWarpDecayDedupTest {
    private val sources: Map<String, String> by lazy {
        mapOf(
            "VisualizerRenderer" to repoFile("src/main/java/dev/geode/render/VisualizerRenderer.kt"),
            "FxCompositor" to repoFile("src/main/java/dev/geode/export/FxCompositor.kt"),
        )
    }
