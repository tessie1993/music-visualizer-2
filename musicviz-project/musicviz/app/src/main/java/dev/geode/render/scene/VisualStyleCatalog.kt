...
internal object VisualStyleCatalog {
    ...
    data class MycoStyle(
        ...
        val deposit: Float = 0.32f,
        val decay: Float = 0.93f,
    ...
    val myco: List<MycoStyle> =
        listOf(
            ...
            MycoStyle(
                ...
                agentRes = 160, sensorDist = 14f, jitter = 0.12f, deposit = 0.10f,
                decay = 0.965f, look = 2, exposure = 3.2f, hueOffset = 0.58f,
            ),
            MycoStyle(
                "myco_circuit", "Circuit Bloom",
                agentRes = 176, sensorAngle = 0.6f, jitter = 0f, deposit = 0.3f,
                decay = 0.9f, snap = 0.7854f, look = 3, exposure = 2.2f, hueOffset = 0.35f,
            ),
            MycoStyle(
                "myco_silkroad", "Silk Roads",
                agentRes = 176, sensorDist = 22f, sensorAngle = 0.18f, turnAngle = 0.12f,
                moveStep = 1.35f, jitter = 0.02f, deposit = 0.26f, decay = 0.945f,
            ...
            MycoStyle(
                ...
                moveStep = 0.75f, deposit = 0.36f, decay = 0.92f,
                look = 5, exposure = 2.8f, hueOffset = 0.98f,
            ),
            MycoStyle(
                "myco_frostvein", "Frost Veins",
                agentRes = 176, sensorDist = 10f, sensorAngle = 0.35f, turnAngle = 0.5f,
                moveStep = 0.9f, deposit = 0.3f, decay = 0.935f, aniso = 0.8f,
