...
| Parameter | Tab | Rolled by | Preset key | Shader | Particle | MilkDrop | Fluid | Curl Flow | Water | Cymatics | Hyperspace | Beam | Composite | Export |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
...
| Parameter | Tab | Rolled by | Preset key | Shader | Particle | MilkDrop | Fluid | Curl Flow | Water | Cymatics | Beam | Hyperspace | Beam | Composite | Export |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| `speed` | Motion | `Speed` | `speed` | · | · |   | · | · | · | · |   | · |   | · | · |
| `zoom` | Motion | `Zoom` | `zoom` | · | · | · |   |   |   |   |   | · |   | · | · |
| `rotation` | Motion | `Rotation` | `rotation` | · | · | · |   | · |   |   |   | · |   | · | · |
